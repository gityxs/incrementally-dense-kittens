...
var cnItems = {
    ...
    "(Legend) Grey: Not Found; Half Brightness: Found in a previous reset; Bright: Found this reset": "（图例）灰色：未找到； 半亮度：在之前的重置中发现； Bright：发现这个重置",
    "Equip More Cats!": "装备更多的猫！",
    "Open more eggs at once": "一次打开更多鸡蛋",
    ...
    "Gain more points scaling based on pet rarity and egg cost!": "根据宠物稀有度和鸡蛋成本获得更多点数！",
    "Health:": "生命值：",
    "Hydraulic Press": "液压机",
    "Hydraulic Press!": "液压机！",
    ...
    "Too many cats? Unlock the Hydraulic press and new eggs based on compacting cats together": "猫太多了？ 将猫压在一起解锁液压机和新鸡蛋",
